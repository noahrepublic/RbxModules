...
local Trove = require(script.Parent:WaitForChild("Trove"))
...
function ServiceBag.new(parentProvider)
	local self = setmetatable({}, ServiceBag)
...
function ServiceBag:CreateScope()
	...
	self._trove[provider] = provider._destroying:Connect(function()
		self._trove[provider] = nil
